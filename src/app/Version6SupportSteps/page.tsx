            ...
            <ThemeProvider theme={darkNavyBlueTheme}>
                ...
                >
                    ...
                    >
                        ...
                        <br />
                        <Typography variant="h6">
                            in this page we will only cover the required steps
                        ...
                        <Typography variant="h6">
                            ...
                            version and the required plugins for the system to
                            work.
                        </Typography>
                        <br />
                        <Typography variant="h6">
                        ...
                        <br />
                        <Typography variant="h6">
                            The experiment files should be added to the root
                            folder. Do not add the experiments files in the sub
                            folder (jspsych-6.3.1)
                        </Typography>
                        <br />
                        <Typography variant="h6">
                            Every time you create a Survey, make sure you save
                            it in the this folder. Otherwise the experiment will
                            not work
                        </Typography>
                    </Box>
                </Container>
